      ...
      <div className="relative w-full max-w-md rounded-2xl border border-electric-cyan/30 bg-card p-6 shadow-[0_0_60px_rgba(0,200,255,0.2)]">
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Button
              asChild
              className="w-full h-12 bg-linear-to-r from-[#f09433] via-[#e6683c] to-[#bc1888] hover:opacity-90 text-white"
            >
            ...
            <Button
              asChild
              className="w-full h-12 bg-[#FF0000] hover:bg-[#FF0000]/90 text-white"
            >
