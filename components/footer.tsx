...
import { FACEBOOK_URL, INSTAGRAM_URL, TIKTOK_URL, YOUTUBE_URL } from "@/lib/utils"
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-2">
                <Link
                  ...
                  className="w-8 h-8 rounded-lg bg-secondary/50 border border-border flex items-center justify-center text-muted-foreground hover:text-[#1877f2] hover:border-[#1877f2]/30 transition-colors"
                  aria-label="Facebook"
                >
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 rounded-lg bg-secondary/50 border border-border flex items-center justify-center text-muted-foreground hover:text-[#e4405f] hover:border-[#e4405f]/30 transition-colors"
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 rounded-lg bg-secondary/50 border border-border flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-foreground/30 transition-colors"
                  aria-label="TikTok"
                >
            ...
            <Image alt="Comgate platební brána logo" width={550} height={150} src="/comgate-payments.png" />
          </Link> 
            ...
            <nav className="flex items-center gap-6 text-sm">
              ...
              <Link href="/jak-objednat" className="text-muted-foreground hover:text-electric-cyan transition-colors">
                Jak probíhá nákup
              </Link>
            </nav>
          </div>
